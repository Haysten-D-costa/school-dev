      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between gap-4 h-20">
          ...
          <Link href="/" className="flex items-center gap-3.5 min-w-0 shrink-0 group">
            <div className="w-12 h-12 rounded-full flex items-center justify-center shrink-0 bg-primary transition-all duration-300 group-hover:scale-105">
              <GraduationCap size={22} className="text-cream" />
            </div>
            <div className="min-w-0 flex flex-col leading-tight">
              <span className="block font-heading font-bold text-sm sm:text-base tracking-wide text-primary">
                {siteConfig.name}
              </span>
